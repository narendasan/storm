...
public class NodeInfo implements org.apache.thrift.TBase<NodeInfo, NodeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<NodeInfo> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // PORT
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set648 = iprot.readSetBegin();
                struct.port = new HashSet<Long>(2*_set648.size);
                long _elem649;
                for (int _i650 = 0; _i650 < _set648.size; ++_i650)
                {
                  _elem649 = iprot.readI64();
                  struct.port.add(_elem649);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        org.apache.thrift.protocol.TSet _set653 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.port = new HashSet<Long>(2*_set653.size);
        long _elem654;
        for (int _i655 = 0; _i655 < _set653.size; ++_i655)
        {
          _elem654 = iprot.readI64();
          struct.port.add(_elem654);
        }
      }
      struct.set_port_isSet(true);
    }
