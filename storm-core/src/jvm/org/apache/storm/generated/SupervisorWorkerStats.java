...
public class SupervisorWorkerStats implements org.apache.thrift.TBase<SupervisorWorkerStats, SupervisorWorkerStats._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorWorkerStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.worker_stats = new HashMap<String,WorkerStats>(2*_map638.size);
                String _key639;
                WorkerStats _val640;
                for (int _i641 = 0; _i641 < _map638.size; ++_i641)
                {
                  _key639 = iprot.readString();
                  _val640 = new WorkerStats();
                  _val640.read(iprot);
                  struct.worker_stats.put(_key639, _val640);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.worker_stats != null) {
        if (struct.is_set_worker_stats()) {
          oprot.writeFieldBegin(WORKER_STATS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, WorkerStats> _iter642 : struct.worker_stats.entrySet())
            {
  ...
  private static class SupervisorWorkerStatsTupleScheme extends TupleScheme<SupervisorWorkerStats> {
      ...
      if (struct.is_set_worker_stats()) {
        {
          ...
          for (Map.Entry<String, WorkerStats> _iter643 : struct.worker_stats.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorWorkerStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map644 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.worker_stats = new HashMap<String,WorkerStats>(2*_map644.size);
          String _key645;
          WorkerStats _val646;
          for (int _i647 = 0; _i647 < _map644.size; ++_i647)
          {
            _key645 = iprot.readString();
            _val646 = new WorkerStats();
            _val646.read(iprot);
            struct.worker_stats.put(_key645, _val646);
          }
        }
        struct.set_worker_stats_isSet(true);
      }
