...
public class LSWorkerStats implements org.apache.thrift.TBase<LSWorkerStats, LSWorkerStats._Fields>, java.io.Serializable, Cloneable, Comparable<LSWorkerStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.metrics = new HashMap<String,Double>(2*_map610.size);
                String _key611;
                double _val612;
                for (int _i613 = 0; _i613 < _map610.size; ++_i613)
                {
                  _key611 = iprot.readString();
                  _val612 = iprot.readDouble();
                  struct.metrics.put(_key611, _val612);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.metrics != null) {
        if (struct.is_set_metrics()) {
          oprot.writeFieldBegin(METRICS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter614 : struct.metrics.entrySet())
            {
              oprot.writeString(_iter614.getKey());
              oprot.writeDouble(_iter614.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class LSWorkerStatsTupleScheme extends TupleScheme<LSWorkerStats> {
      ...
      if (struct.is_set_metrics()) {
        {
          ...
          for (Map.Entry<String, Double> _iter615 : struct.metrics.entrySet())
          {
            oprot.writeString(_iter615.getKey());
            oprot.writeDouble(_iter615.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSWorkerStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map616 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.metrics = new HashMap<String,Double>(2*_map616.size);
          String _key617;
          double _val618;
          for (int _i619 = 0; _i619 < _map616.size; ++_i619)
          {
            _key617 = iprot.readString();
            _val618 = iprot.readDouble();
            struct.metrics.put(_key617, _val618);
          }
        }
        struct.set_metrics_isSet(true);
      }
