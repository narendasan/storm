...
public class WorkerStats implements org.apache.thrift.TBase<WorkerStats, WorkerStats._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.metrics = new HashMap<Long,LSWorkerStats>(2*_map620.size);
                long _key621;
                LSWorkerStats _val622;
                for (int _i623 = 0; _i623 < _map620.size; ++_i623)
                {
                  _key621 = iprot.readI64();
                  _val622 = new LSWorkerStats();
                  _val622.read(iprot);
                  struct.metrics.put(_key621, _val622);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.executor_infos = new ArrayList<ExecutorInfo>(_list624.size);
                ExecutorInfo _elem625;
                for (int _i626 = 0; _i626 < _list624.size; ++_i626)
                {
                  _elem625 = new ExecutorInfo();
                  _elem625.read(iprot);
                  struct.executor_infos.add(_elem625);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.metrics != null) {
        if (struct.is_set_metrics()) {
          oprot.writeFieldBegin(METRICS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Long, LSWorkerStats> _iter627 : struct.metrics.entrySet())
            {
      ...
      if (struct.executor_infos != null) {
        if (struct.is_set_executor_infos()) {
          oprot.writeFieldBegin(EXECUTOR_INFOS_FIELD_DESC);
          {
            ...
            for (ExecutorInfo _iter628 : struct.executor_infos)
            {
  ...
  private static class WorkerStatsTupleScheme extends TupleScheme<WorkerStats> {
      ...
      if (struct.is_set_metrics()) {
        {
          ...
          for (Map.Entry<Long, LSWorkerStats> _iter629 : struct.metrics.entrySet())
          {
            oprot.writeI64(_iter629.getKey());
      ...
      if (struct.is_set_executor_infos()) {
        {
          ...
          for (ExecutorInfo _iter630 : struct.executor_infos)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, WorkerStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map631 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.metrics = new HashMap<Long,LSWorkerStats>(2*_map631.size);
          long _key632;
          LSWorkerStats _val633;
          for (int _i634 = 0; _i634 < _map631.size; ++_i634)
          {
            _key632 = iprot.readI64();
            _val633 = new LSWorkerStats();
            _val633.read(iprot);
            struct.metrics.put(_key632, _val633);
          }
        }
        struct.set_metrics_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.executor_infos = new ArrayList<ExecutorInfo>(_list635.size);
          ExecutorInfo _elem636;
          for (int _i637 = 0; _i637 < _list635.size; ++_i637)
          {
            _elem636 = new ExecutorInfo();
            _elem636.read(iprot);
            struct.executor_infos.add(_elem636);
          }
        }
        struct.set_executor_infos_isSet(true);
      }
